...
NSE_12_TICKER = ['RELIANCE.NS','HDFCBANK.NS','INFY.NS','HDFC.NS','TCS.NS','ICICIBANK.NS',
                 'KOTAKBANK.NS','HINDUNILVR.NS','ITC.NS']

NSE_13_TICKER = ['RELIANCE.NS','HDFCBANK.NS','INFY.NS','HDFC.NS','TCS.NS','ICICIBANK.NS',
                 'KOTAKBANK.NS','HINDUNILVR.NS','ITC.NS','BHARTIARTL.NS',
                 'LT.NS','AXISBANK.NS', 'BAJFINANCE.NS', 'MARUTI.NS','ASIANPAINT.NS',
		  'HCLTECH.NS','SBIN.NS','NESTLEIND.NS', 'M&M.NS','SUNPHARMA.NS',
		 'DRREDDY.NS', 'ULTRACEMCO.NS','POWERGRID.NS','HDFCLIFE.NS',
		 'BRITANNIA.NS','TITAN.NS','TECHM.NS','NTPC.NS','WIPRO.NS','BAJAJ-AUTO.NS']
